...
import com.example.hilibrary.navigation.MyFragmentNavigator.Destination
...
public open class MyFragmentNavigator(
    private val context: Context,
    private val fragmentManager: FragmentManager,
    private val containerId: Int
) : Navigator<MyFragmentNavigator.Destination>() {
...
//        ft.replace(containerId, frag)
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) :
        ...
        public constructor(navigatorProvider: NavigatorProvider) :
                this(navigatorProvider.getNavigator(MyFragmentNavigator::class.java))
